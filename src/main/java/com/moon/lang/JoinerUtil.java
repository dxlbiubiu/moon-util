...
public final class JoinerUtil {
    ...
    public static StringJoiner of(CharSequence delimiter) {
        return StringJoiner.of(delimiter);
    }
    ...
    public static <T> String joinRequireNonNull(T[] array) {
        return joinRequireNonNull(array, DFT_SEP);
    }
    ...
    public static <T> String joinSkipNulls(T[] array) {
        return joinSkipNulls(array, DFT_SEP);
    }
    ...
    public static <T> String joinUseForNull(T[] array, T forNull) {
        return joinUseForNull(array, forNull, DFT_SEP);
    }
    ...
    public static <T> String join(Collection<T> collection) {
        return join(collection, DFT_SEP);
    }
    ...
    public static <T> String joinSkipNulls(Collection<T> collection) {
        return joinSkipNulls(collection, DFT_SEP);
    }
    ...
    public static <T> String joinRequireNonNull(Iterable<T> iterable) {
        return joinRequireNonNull(iterable, DFT_SEP);
    }
    ...
    public static <T> String joinRequireNonNull(Iterable<T> iterable, String separator) {
        ...
        StringBuilder sb = new StringBuilder((sepLen + DFT_LEN) * 16);
        for (T item : iterable) {
            sb.append(separator).append(requireNonNull(item));
        }
        return sb.substring(sepLen);
    }

    public static <T> String joinSkipNulls(Iterable<T> iterable) {
        return joinSkipNulls(iterable, DFT_SEP);
    }
    ...
    public static <T> String joinRequireNonNull(Iterator<T> iterator) {
        return joinRequireNonNull(iterator, DFT_SEP);
    }
    ...
    public static <T> String joinRequireNonNull(Iterator<T> iterator, String separator) {
        ...
        StringBuilder sb = new StringBuilder((sepLen + DFT_LEN) * 16);
        while (iterator.hasNext()) {
            sb.append(separator).append(requireNonNull(iterator.next()));
        }
        return sb.substring(sepLen);
    }

    public static <T> String joinSkipNulls(Iterator<T> iterator) {
        return joinSkipNulls(iterator, DFT_SEP);
    }
    ...
    private static int separatorLength(CharSequence cs) {
        return cs == null ? 4 : cs.length();
    }
