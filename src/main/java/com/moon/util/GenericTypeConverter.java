...
public class GenericTypeConverter implements TypeConverter {
    ...
    private void registerDefaultConverter() {
        ...
        add(Collection.class, (value, toType) -> {
            ...
            Class cls;
            CollectionBuilder builder = collectionAccessor.getOrReload();
        ...
        add(List.class, (value, toType) -> {
            ...
            ListBuilder builder = listAccessor.getOrReload();
            if (value instanceof List) {
    ...
    private <C> BiFunction<Object, Class<C>, C> converterOfMap() {
        return (value, toType) -> {
            ...
            Class cls;
            MapBuilder builder = mapAccessor.getOrReload();
    ...
    public <T> T[] toTypeArray(Object value, Class<T> componentType) {
        ...
        Class cls;
        ArrayBuilder builder = arrayAccessor.getOrReload();
        if (value instanceof List) {
    ...
    private static class CollectionBuilder {
        Collection toCollection(Map value, Class listImplType) {
            return createCollection(listImplType, isAbstract(listImplType), value.values());
        }
        ...
        Collection toCollection(Collection value, Class listImplType) {
            ...
            return createCollection(listImplType, isAbstract(listImplType), value);
        }
        ...
        Collection toCollection(Object[] array, Class listImplType) {
            ...
            if (isDefault) {
                ...
                return createCollection(listImplType, isDefault, ListUtil.toList(array));
            }
        }
        ...
        Collection toCollection(Object value, Class listImplType) {
            Collection ret = createCollection(listImplType, isAbstract(listImplType));
            ret.add(value);
            return ret;
        }

        <T extends Collection> Collection createCollection(Class<T> listImplType, boolean isDefault, Collection c) {
            Collection list = createCollection(listImplType, isDefault);
            list.addAll(c);
            return list;
        }

        <T extends Collection> Collection createCollection(Class<T> listImplType, boolean isDefault) {
